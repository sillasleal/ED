...
/**
 * Classe base para os nós usados
 *
 * @author Sillas S.Leal <sillas.s.leal@gmail.com>
 * @param <T>
 */
public class NodeComparable<T extends Comparable> {
     ...
     * O objeto seguinte
     */
    protected NodeComparable right;

    /**
     * Construtor
     */
    public NodeComparable() {
        this.data = null;
    }
     ...
     */
    public NodeComparable setData(T data) {
        this.data = data;
        /**/
        return this;
    }
     ...
     */
    public NodeComparable getRight() {
        return right;
    }
     ...
     * @return Método fluente. Retorna uma instância do próprio objeto.
     */
    public NodeComparable setRight(NodeComparable right) {
        this.right = right;
        /**/
        return this;
    }
